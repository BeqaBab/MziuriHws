...
public class Task1 {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        LMS lms = new LMS();
        File file = new File("C:\\Users\\beqab\\MziuriHws\\src\\HW1225\\LMS.txt");
        if(file.length() > 0){
            FileInputStream fileInputStream = new FileInputStream("C:\\Users\\beqab\\MziuriHws\\src\\HW1225\\LMS.txt");
        ...
        FileOutputStream fileOutputStream = new FileOutputStream("C:\\Users\\beqab\\MziuriHws\\src\\HW1225\\LMS.txt");
